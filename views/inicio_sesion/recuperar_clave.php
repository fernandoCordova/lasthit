                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="correo" class="label-personalizado">Ingrese el correo de restauracion</label>
                                    </div>
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid"><a class="btn boton-general btn-block" href="cambiar_clave">Enviar correo de restauracion</a></div>
                                    </div>
                                </form>
                            </div>
                        </div>
